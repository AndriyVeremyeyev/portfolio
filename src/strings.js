const strings = {
  ...
  nurseSchedulerAbout: `This application was made to ease the work of a nurse scheduler. The nurse scheduler can input the nurse's requests which consist of vacation start date, vacation end date, a number of days requested off & additional comments as required.
  This application also allows a nurse scheduler to add work requests made by nurses and display it for references and update the due dates for form submission.`,
};
